...
def recommend_meals():
    ...
    return meal_history, food_classes_eaten

# Function to simulate for 30 days and log the data
def simulate_monthly_meals():
    for day in range(1, 31):
        print(f"\nDay {day}:\n")
        meal_history, food_classes = recommend_meals()
        log_meal_data(day, meal_history, food_classes)
